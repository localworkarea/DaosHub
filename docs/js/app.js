(() => {
    ...
    class Popup {
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    ...
                    if (popupContent.classList.contains("_form-sent")) popupContent.classList.remove("_form-sent");
        ...
        close(selectorValue) {
            ...
            const popupContent = document.querySelector(".popup__content");
            if (popupContent.classList.contains("_form-sent")) setTimeout((() => {
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            const popupContent = document.querySelector(".popup__content");
            if (popupContent) popupContent.classList.add("_form-sent");
            formValidate.formClean(form);
